...
def main() -> None:
    ...
    required_paths = [
        ...
        workspace / "output/pipeline/01_yolo_base.mp4",
        workspace / "output/pipeline/02_llamacpp_q8_timeline.json",
        workspace / "output/pipeline/03_final_llamacpp_q8.mp4",
        workspace / "output/pipeline/manifest.json",
        workspace / "output/hands_on/prompt_comparison.json",
